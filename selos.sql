...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Nov-2021 às 13:47
...
(5, '2021_11_10_120542_create_utilizadors_table', 1),
(6, '2021_11_11_165720_create_tests_table', 2);
...
INSERT INTO `tests` (`id`, `created_at`, `updated_at`, `nome`) VALUES
(1, NULL, NULL, 'Antonio José'),
(2, NULL, NULL, 'Honorio'),
(3, NULL, NULL, 'Mateya');
...
INSERT INTO `utilizadors` (`id`, `created_at`, `updated_at`, `nome`, `email`, `senha`, `acesso`, `tipo`, `token`) VALUES
(1, NULL, NULL, 'Honório Eduardo', 'hsilva@mredis.com', 'Hkn15D77', '2', 'Admin', '');
